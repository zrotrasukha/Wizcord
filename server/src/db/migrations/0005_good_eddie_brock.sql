...
ALTER TABLE "server_member" ADD CONSTRAINT "server_member_serverId_server_id_fk" FOREIGN KEY ("serverId") REFERENCES "public"."server"("id") ON DELETE no action ON UPDATE no action;